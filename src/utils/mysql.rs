...
impl Chapter {
    pub(crate) fn new(id: String, title: String, pic: String, sort: u32, price: u32, items: Vec<String>) -> Self {
        Chapter {
            id,
            title,
            pic,
...
impl Book{
    pub(crate) fn new(id: String, title: String, author: String, note: String, pic: String, big_pic: String, praise_count: u64, click_count: u64, favorite_count: u64, over_type: String, category_id: u64, sort: u32, tags: String, chapters: Vec<Chapter>) -> Self {
        Book {
            id,
            title,
            author,
